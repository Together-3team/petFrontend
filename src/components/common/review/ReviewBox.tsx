...
export default function ReviewBox() {
  const testData = {
    ...
    rating: 4,
    description:
      '설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 설이는 귀여워 귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워 설이는 귀여워 귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워 설이는 귀여워 귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워 설이는 귀여워 귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워귀여워 설이는 귀여워 귀여워귀여워 설이는 귀여워 귀여워귀여워',
